...
This pipeline is designed to run on the IDIA/Ilifu cluster, making use of SLURM and MPICASA. For other uses, please contact the authors. Currently, use of the pipeline requires access to the IDIA/Ilifu cloud infrastructure.
